...
public class MissedAppointmentsOtherPharmAPSSExcel implements IRunnableWithProgress {
    ...
    public MissedAppointmentsOtherPharmAPSSExcel(SWTCalendar swtCal,
    ...
    public void run(IProgressMonitor monitor) throws InvocationTargetException, InterruptedException {
        try {
            ...
            monitor.beginTask("Por Favor, aguarde ... ", 1);
                ...
                chamadaTelefonicaXLSs = con.getMissedAppointmentOtherPharmsReport(txtMinimumDaysLate,txtMaximumDaysLate,
