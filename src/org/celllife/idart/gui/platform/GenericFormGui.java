...
//		lblBg.setBackground(ResourceUtils.getColor(iDartColor.WIDGET_NORMAL_SHADOW_BACKGROUND));
	...
	/**
	 * Method buildCompHeader for Alert.
	 * @param headerTxt String
	 * @param icoImage iDartImage
	 */
	protected void buildCompHeaderAlerta(String headerTxt, iDartImage icoImage) {
...
//		lblBg.setBackground(ResourceUtils.getColor(iDartColor.WIDGET_NORMAL_SHADOW_BACKGROUND));
	...
	protected void buildCompHeaderSync(String headerTxt, iDartImage icoImage) {
...
//		// btnSync
//		btnSync = new Button(getCompButtons(), SWT.NONE);
...
//				.getString("Clique para sincronizar dados")); //$NON-NLS-1$
