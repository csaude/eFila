...
public class PatientSearchOpenMrs extends GenericOthersGui {
	...
	public PatientSearchOpenMrs(Shell parent, Session session) {
	...
	public PatientIdentifier searchByName(String patientId) {
		...
		updateTable();
		waitForClose();
		Set<PatientIdentifier> setPatientIdentifiers = new HashSet<PatientIdentifier>(identifiers);
		if (selectedIdentifier!=null){
			Patient patient = selectedIdentifier.getPatient();
			patient.setPatientIdentifiers(setPatientIdentifiers);
		}
		return selectedIdentifier;
	}
