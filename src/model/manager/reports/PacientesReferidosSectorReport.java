 ...
 * @author colaco
 */
public class  PacientesReferidosSectorReport extends AbstractJasperReport {
	...
	public PacientesReferidosSectorReport(Shell parent, StockCenter stockCenter, Date theStartDate,
			Date theEndDate) {
		super(parent);
	...
	protected String getReportFileName() {
		return "PacientesReferidosParaSectorClinico";
	}
