...
public class PackageManager {
    ...
    public static Prescription getPrescriptionFromPatient(Session session,
                                                          Patient patient, Date datePickup) throws HibernateException {
        Prescription id = null;
        List<Prescription> presc = null;
        presc = session.createQuery(
                "select prescription from Prescription as prescription "
     ...
     *
     * @param sess                        Session
     * @param preToBeSaved                Prescription
     * @param previousPrescriptionDeleted boolean
     * @throws HibernateException
     ...
     * @param endDate   Date
     * @param lifeStage PackageLifeStage
     * @return List<Packages>
     * @throws HibernateException
     */
    @SuppressWarnings("unchecked")
    ...
    public static void savePackageQty0(Packages packageToSave)
            throws HibernateException {
     ...
     *
     * @param sess          Session
     * @param pdisForLabels List<PackageDrugInfo>
     * @param qtysForLabels PackageInfo
     * @return boolean
     * @throws HibernateException
     */
